	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int iPriorityId = mPriorityRadioGroup.getCheckedRadioButtonId();

				switch (iPriorityId) {
					case R.id.lowPriority: 	priority = Priority.LOW; break;
					case R.id.medPriority: 	priority = Priority.MED; break;
					case R.id.highPriority: priority = Priority.HIGH; break;
				}

				// TODO - Get the current Status

				Status status = null;
				int iStatusId = mStatusRadioGroup.getCheckedRadioButtonId();

				switch (iStatusId) {
					case R.id.statusDone: 	 status = Status.DONE; break;
					case R.id.statusNotDone: status = Status.NOTDONE; break;
				}
